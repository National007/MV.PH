...
function dTree(objName) {
	...
	this.icon = {
		root				: '/lib/dtree/images/base.gif',
		folder			: '/lib/dtree/images/folder.gif',
		folderOpen	: '/lib/dtree/images/folderopen.gif',
		node				: '/lib/dtree/images/page.gif',
		empty				: '/lib/dtree/images/empty.gif',
		line				: '/lib/dtree/images/line.gif',
		join				: '/lib/dtree/images/join.gif',
		joinBottom	: '/lib/dtree/images/joinbottom.gif',
		plus				: '/lib/dtree/images/plus.gif',
		plusBottom	: '/lib/dtree/images/plusbottom.gif',
		minus				: '/lib/dtree/images/minus.gif',
		minusBottom	: '/lib/dtree/images/minusbottom.gif',
		nlPlus			: '/lib/dtree/images/nolines_plus.gif',
		nlMinus			: '/lib/dtree/images/nolines_minus.gif'
	};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
